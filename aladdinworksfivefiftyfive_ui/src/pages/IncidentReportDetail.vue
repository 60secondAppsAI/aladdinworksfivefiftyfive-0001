              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Incident Report Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Report Content</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ReportContent" type="text" placeholder="Enter ReportContent" v-model="incidentReportDetails.reportContent"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Report Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="incidentReportDetails.reportDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
